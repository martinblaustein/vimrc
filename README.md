...
* [open_file_under_cursor.vim](https://github.com/martinblaustein/open_file_under_cursor.vim): Open file under cursor when pressing `gf`
...
* [goyo.vim](https://github.com/junegunn/goyo.vim) and [vim-zenroom2](https://github.com/martinblaustein/vim-zenroom2): 
Remove all clutter and focus only on the essential. Similar to iA Writer or Write Room [Read more here](http://martinblaustein.dk/blog/post/19744)
...
* [Vim: Annotate strings with gettext (the macro way)](http://martinblaustein.dk/blog/post/19678#Vim-Annotate-strings-with-gettext-the-macro-way)
* [vimgrep: Searching through multiple file extensions](http://martinblaustein.dk/blog/post/19672#vimgrep-Searching-through-multiple-file-extensions)
* [Filtering through vimgrep results using regular expressions](http://martinblaustein.dk/blog/post/19666#Filtering-through-vimgrep-results-using-regular-expressions)
* [PeepOpen - File auto completion for Mac editors](http://martinblaustein.dk/blog/post/19601#PeepOpen-File-auto-completion-for-Mac-editors)
* [Vim 7.3: Persistent undo and encryption!](http://martinblaustein.dk/blog/post/19548#Vim-7-3-Persistent-undo-and-encryption)
* [Vim tips: Visual Search](http://martinblaustein.dk/blog/post/19334#Vim-tips-Visual-Search)
* [Folding in Vim](http://martinblaustein.dk/blog/post/19132#Folding-in-Vim)
* [
Zen room for Vim: Focusing only on the essential](http://martinblaustein.dk/blog/post/19744#zenroom-for-Vim-Focsuing-only-on-the-essential)
